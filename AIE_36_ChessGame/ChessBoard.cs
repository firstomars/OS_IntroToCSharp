...
namespace AIE_36_ChessGame
{
    class ChessBoard
    {
        ...
        public ChessBoard()
        {
            ...
            //board[3, 4] = new ChessPieceRook(this, EChessSide.BLACK, 3, 4);
            ...
            board[4, 5] = new ChessPieceBishop(this, EChessSide.WHITE, 4, 5);

            board[4, 1] = new ChessPiecePawn(this, EChessSide.WHITE, 4, 1);
