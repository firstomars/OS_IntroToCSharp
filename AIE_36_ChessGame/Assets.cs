...
namespace AIE_36_ChessGame
{
    static class Assets
    {
        ...
        public static void Load()
        {
            ...
            chessPieceSrcRects[EChessSide.WHITE][ChessPiece.Type.QUEEN] = new Rectangle(1 * spriteW, 0 * spriteH, spriteW, spriteH);
            chessPieceSrcRects[EChessSide.BLACK][ChessPiece.Type.QUEEN] = new Rectangle(1 * spriteW, 1 * spriteH, spriteW, spriteH);
            chessPieceSrcRects[EChessSide.WHITE][ChessPiece.Type.KING] = new Rectangle(0 * spriteW, 0 * spriteH, spriteW, spriteH);
            chessPieceSrcRects[EChessSide.BLACK][ChessPiece.Type.KING] = new Rectangle(0 * spriteW, 1 * spriteH, spriteW, spriteH);
